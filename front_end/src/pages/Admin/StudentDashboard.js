  ...
  return (
    <div className="teacherDash min-h-screen bg-white p-6">
          <div className="header flex justify-between mb-2 mt-1">
              ...
              <button type="button" class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 shadow-lg shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-base px-5 py-2.5 text-center me-2">Add New Student</button>
      </div>
...
<div class="py-8 w-full">
  <div class="shadow drop-shadow-lg overflow-x-auto rounded border-b border-gray-200">
    ...
    <tbody class="text-gray-700">
      <tr>
        <td class="text-left py-3 px-4 text-lg">Student one</td>
      ...
      <tr class="bg-gray-100">
        <td class="text-left py-3 px-4 text-lg">Student two</td>
       <td class="text-left py-3 px-4 text-lg">0123456789</td>
      ...
      <tr>
        <td class="text-left py-3 px-4  text-lg">Student 3</td>
        <td class="text-left py-3 px-4  text-lg">0123456789</td>
      ...
      <tr class="bg-gray-100">
        <td class="text-left py-3 px-4 text-lg">Student fourrrr</td>
        <td class="text-left py-3 px-4 text-lg">0123456789</td>
