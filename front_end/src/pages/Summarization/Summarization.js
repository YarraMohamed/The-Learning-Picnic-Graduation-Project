      ...
      <div className="summarizeContainer">
          ...
          <div className="summarizeText">
            {lesson.summary !== "" ? (
              ...
              id = "message"
              rows= "22"
              className='resize-none block m-auto my-3 p-3 w-11/12 text-xl text-black-900 bg-white-40 rounded-2xl border border-gray-500 dark:bg-white-700 dark:border-gray-800 dark:text-black-900'
              ...
              rows= "22"
              className='resize-none block m-auto my-3 p-3 w-11/12 text-xl text-black-900 bg-white-40 rounded-2xl border border-gray-500 dark:bg-white-700 dark:border-gray-800 dark:text-black-900'
              value="Please Check Again Later For The Lesson's Summary.">
              </textarea>
            )
            }
