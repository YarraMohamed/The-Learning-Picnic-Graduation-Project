      ...
      <div class="quizCard py-2">
        ...
        <Link to={`/showQuizPT/${props._id}`}>
          ...
          <div className='row-auto items-center justify-center mx-auto mb-2'>
              ...
              <button type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base px-3 py-2.5 mr-1 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete</button>
