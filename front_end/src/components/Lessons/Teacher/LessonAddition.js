    ...
    axios.post(`${process.env.REACT_APP_API_URL}/lessons/`, formData, {
      ...
      .then((resp) => {
        setLesson({
          ...
          err: null,
          loading: false,
          successMessage: "Lesson Uploaded Successfully",
          fileUploaded: false,
          uploadedFileName: ''
        });
    ...
    <div className='heroLessonAddition'>
      <form class="w-3/5 h-svh mx-auto my-4" onSubmit={createLesson}>
        ...
        <div class="flex items-center justify-center w-full mb-4">
          ...
          <input id="dropzone-file" className="hidden" type="file" class="hidden" ref={pdfFile} required onChange={handleFileChange} />
          </label> */}
            <label 
